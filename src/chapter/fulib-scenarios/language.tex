...
\begin{codeblock}
    We take a student from students of uni and we add 1 to semester of student.
\end{codeblock}
...
Listen haben in der Scenario-Sprache eine große Bedeutung, weshalb weitere Sprachfeatures das Arbeiten damit vereinfachen.
...
\begin{codeblock}
    ...
    Do-work removes 1 from motivation of Alice.
\end{codeblock}
