...
Die \code{init}-Methode kann demnach wie folgt gefüllt werden:
...
Geschachtelte Aufrufe können stattfinden, wenn das Subjekt eines \code{Call}-Satzes einem darüberliegenden Methodennamen entspricht.
