...
Die Verarbeitung dieses Baumes ist dann Aufgabe der Analysephase.
...
Dies ist beispielsweise bei jenen der Fall, die unter einem \code{call}-Satz stehen, welche im vorherigen Abschnitt unter~\ref{subsec:methods} näher erläutert wurden.
