...
\codelisting{antlr}{chapter/fulib-scenarios/grammars}{ScenarioLexer1.g4}{Ausschnitt der Scenario-Lexer-Grammatik}
...
\codelisting{antlr}{chapter/fulib-scenarios/grammars}{ScenarioParser1.g4}{Ausschnitt der Scenario-Parser-Grammatik}
...
Die \code{thereSentence}-Regel aus Listing~\ref{lst:ScenarioParser1.g4} beginnt beispielsweise mit den Terminalen \code{THERE}, \code{IS}, \code{A} und \code{WORD}, gefolgt von dem Nicht-Terminal \code{withClause}.
...
In Listing~\ref{lst:ScenarioParser1.g4} dient \code{file} als Startregel.
