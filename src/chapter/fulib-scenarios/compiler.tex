...
\todo{
Dateiname "src/main/scenarios/org/example/CompilationExample.md".
}
...
Ein \code{HEADLINE}-Token entsteht, wenn auf ein \code{#}-Zeichen beliebig viele Zeichen und ein Zeilenumbruch folgen\footnote{
    Dabei bedeutet \code{~[\n]*?} \todo{Inline-Code merkwürdig durch Backslash} \outquote{beliebig viele Zeichen ausgenommen Zeilenumbruch}.
}.
