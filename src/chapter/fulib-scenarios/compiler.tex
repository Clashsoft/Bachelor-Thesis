...
Damit eine Programmiersprache verwendbar ist, muss sie nicht nur in Syntax und Semantik definiert sein, sondern auch ausführbar sein.
...
Der erzeugte Java-Quellcode wird dann vom Java-Compiler in ausführbaren Bytecode kompiliert.
...
Die Namensauflösung umfasst sowohl die direkte Auflösung von Variablen- und anderen Namen anhand des Scopes,
...
Im \code{IsSentence}-Knoten fällt somit der Typ der \code{CreationExpr} auf.
...
und der globale Scope stellt externe\footnote{Der Scenario-Compiler bietet die Möglichkeit an, Bibliotheken einzubinden.
Dies ist aufgrund der Komplexität hier nicht näher erläutert.} Klassen bereit.
