...
Wenn mehrere Objekte wie z.B.\ \code{game} und \code{Alice} deklariert werden, sind sowohl \code{g=game, p1=Alice} als auch \code{g=Alice, p1=game} mögliche Zuweisungen des Patterns.
