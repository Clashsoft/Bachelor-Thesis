...
\todo{benannter Link-Constraint mittels "Attribut"-Constraint}

% Accessing unknown attributs
Evtl.\ ist es wünschenswert, nach dem Match-Satz auf den Wert des unbekannten Attributs zuzugreifen.
Da jedoch \code{p1} den Typ \code{Object} hat, ist dies in der statisch typisierten Scenario-Sprache nicht möglich, zumal dessen Name nicht bekannt ist.
...
Dies ist mit den üblichen Trennsymbolen \code{and} bzw. \code{,} möglich.
