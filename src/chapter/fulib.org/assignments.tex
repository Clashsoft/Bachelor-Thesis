...
Um dieses anzuzeigen, muss im stets sichtbaren Seitenfooter unter ``Assignments'' der Menüeintrag ``Create Assignment'' ausgewählt werden.
...
Der mit ``Verification'' bezeichnete Editor ist dafür vorgesehen, einen Teil eines Scenarios einzutragen.
...
Zum Veröffentlichen genügt nach Ausfüllen des Formulars ein Klick auf den Button ``Submit''.
