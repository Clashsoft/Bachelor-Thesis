...
\codelisting{java}{chapter/fulib-scenarios/java}{User.java}{\code{User.java}}

\codelisting{java}{chapter/fulib-scenarios/java}{UserRegistry.java}{\code{UserRegistry.java}}

\codelisting{java}{chapter/fulib-scenarios/java}{UserRegistryTest.java}{\code{UserRegistryTest.java}}
